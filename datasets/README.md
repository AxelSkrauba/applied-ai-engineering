...
3. **Documentación:** Cada dataset debe incluir un breve comentario en su README, detallando su origen (referencia a la fuente original), el significado de las columnas y el contexto disponible.
4. **Formato:** Preferentemente `.csv`, `.parquet`, o `.json`. Si amerita, comprimido en `.zip` para eficiencia en la transferencia.
